  ...
  "0.1": {
    ...
    conceptCheck: {
      ...
      options: [
        ...
        "50, because we follow PEMDAS correctly",
        "38, because we multiply first then add",
        "20, because we add first then multiply"
      ],
      correctAnswer: 1,
      explanation: "Following PEMDAS: First calculate 4² = 16, then 3 × 16 = 48, finally 2 + 48 = 50. In data science, incorrect order of operations can lead to completely wrong analysis results."
    },

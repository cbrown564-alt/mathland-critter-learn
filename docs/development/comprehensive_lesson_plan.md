...
| 1.8 | Rational Functions & Asymptotes | **T2** | Graph behavior visualization with asymptote analysis | Mathematical diagram template |
...
### Module 4: Eigenvalues, Eigenvectors & Matrix Decomposition (Eileen)
...
| Lesson | Title | Tier | Rationale | Implementation |
|--------|-------|------|-----------|----------------|
| 6.1 | Optimization Problem Formulation | **T2** | Problem setup with systematic approach | Process flow template |
| 6.2 | Unconstrained Optimization Methods | **T2** | Method comparison with trade-off analysis | Comparison framework template |
| 6.3 | Gradient Descent Algorithm | **T1** | Algorithmic process requires step-by-step visualization | New component: Gradient descent stepper |
| 6.4 | Newton's Method & Second-Order Methods | **T2** | Algorithmic comparison with convergence analysis | Comparison framework template |
| 6.5 | Gradient Descent in Machine Learning | **T1** | ✅ Complex optimization landscapes require interaction | **greta_gradient_descent_climber** (completed) |
| 6.6 | Constrained Optimization & KKT Conditions | **T2** | Theoretical framework with systematic conditions | Process flow template |
| 6.7 | Linear Programming & Simplex Method | **T2** | Algorithmic process with geometric interpretation | Process flow template |
| 6.8 | Convex Optimization & Convex Sets | **T2** | Geometric concepts with theoretical properties | Mathematical diagram template |
| 6.9 | Stochastic Gradient Descent | **T1** | Stochastic process benefits from interactive exploration | New component: Stochastic SGD explorer |
| 6.10 | Applications in Neural Networks | **T3** | Real-world synthesis requiring narrative connection | Greta's adventure-focused applications |

**Module 6 Summary**: 3 Interactive, 6 Enhanced Static, 1 Narrative

### Module 7: Probability Fundamentals (Pippa)
*10 lessons - Magic show with probability distributions*

| Lesson | Title | Tier | Rationale | Implementation |
|--------|-------|------|-----------|----------------|
| 7.1 | Probability Spaces & Events | **T2** | Foundational concepts with visual organization | Mathematical diagram template |
| 7.2 | Conditional Probability & Independence | **T2** | Conceptual framework with logical flow | Process flow template |
| 7.3 | Bayes' Theorem & Applications | **T2** | Systematic application with real-world contexts | Application context template |
| 7.4 | Random Variables & Distributions | **T1** | ✅ Distribution exploration requires parameter manipulation | **pippa_probability_magic** (completed) |
| 7.5 | Expectation & Variance | **T2** | Computational concepts with formula application | Process flow template |
| 7.6 | Common Discrete Distributions | **T2** | Distribution comparison with parameter effects | Comparison framework template |
| 7.7 | Continuous Distributions & Density Functions | **T2** | Theoretical concepts with visual interpretation | Mathematical diagram template |
| 7.8 | Central Limit Theorem | **T1** | Statistical convergence requires interactive demonstration | New component: CLT demonstration |
| 7.9 | Joint Distributions & Covariance | **T2** | Multivariate concepts with systematic development | Mathematical diagram template |
| 7.10 | Probability in Machine Learning | **T3** | Application synthesis requiring narrative integration | Pippa's magical connections |

**Module 7 Summary**: 2 Interactive, 7 Enhanced Static, 1 Narrative

### Module 8: Statistical Inference & Hypothesis Testing (Sigmund)
*10 lessons - Elegant inference with statistical rigor*

| Lesson | Title | Tier | Rationale | Implementation |
|--------|-------|------|-----------|----------------|
| 8.1 | Sampling Distributions & Estimation | **T2** | Theoretical concepts with systematic presentation | Process flow template |
| 8.2 | Confidence Intervals & Interpretation | **T2** | Computational process with conceptual framework | Process flow template |
| 8.3 | Hypothesis Testing Framework | **T2** | Systematic methodology with logical structure | Process flow template |
| 8.4 | Common Statistical Tests | **T1** | ✅ Testing scenarios require interactive exploration | **sigmund_hypothesis_arena** (completed) |
| 8.5 | p-values & Statistical Significance | **T2** | Conceptual framework with interpretation guidance | Mathematical diagram template |
| 8.6 | Type I & Type II Errors | **T2** | Error framework with decision consequences | Comparison framework template |
| 8.7 | Power Analysis & Sample Size | **T2** | Computational process with practical applications | Process flow template |
| 8.8 | Non-parametric Tests | **T2** | Method comparison with applicability conditions | Comparison framework template |
...
**Module 10 Summary**: 3 Interactive, 5 Enhanced Static, 2 Narrative
